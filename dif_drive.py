...
class Envir:
    def __init__(self, dimensions):
        ...
        self.textRect.center = (dimensions[1]-500, dimensions[0]-200)
    ...
    def robot_frame(self, pos, rotation):
        ...
        pygame.draw.line(self.map, self.yellow, (centerx, centery), x_axis, 3)
...
robot = Robot(start, r"D:\VSCode Projects\Differential Drive Robot\images\robot.png", 0.01*3779.52)
...
while running:
    ...
    environment.map.fill(environment.green)
    robot.move()
